// Vaibhav Malhotra
// To make, simply type "make" at a command userPrompt in this directory
...
#include "worker.h"
/*
This function will take in the userPrompt and grab all the arguments and then initialize the command queue. It also intializes all the
accounts and locks any specified accounts. It then reads the user commands and excecutes accordingly. 
*/
int main(int argc, char *argv[]) {
	//User input userPrompt variables
	char userPrompt[2] = ">";
	char input[300];
	char * inputArgs[30];
	...
	while (1) {
		...
		//Display the shell userPrompt
		printf("%s ", userPrompt);

		//Grab input from user userPrompt
